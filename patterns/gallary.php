...
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() );?>/assets/images/gallary1.jpg","id":502,"dimRatio":30,"overlayColor":"dark-blue","focalPoint":{"x":0.54,"y":0.55},"minHeight":500,"minHeightUnit":"px","contentPosition":"bottom center","isDark":false} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"align":"center","id":503,"width":64,"height":64,"sizeSlug":"full","linkDestination":"custom","style":{"border":{"width":"0px","style":"none","radius":"0px"}}} -->
<figure class="wp-block-image aligncenter size-full is-resized has-custom-border"><a href="#"><img src="<?php echo esc_url( get_template_directory_uri() );?>/assets/images/right.png" alt="" class="wp-image-503" style="border-style:none;border-width:0px;border-radius:0px" width="64" height="64"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div></div>
<!-- /wp:cover --></div>
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() );?>/assets/images/gallary3.jpg","id":501,"dimRatio":30,"overlayColor":"dark-blue","focalPoint":{"x":0.55,"y":0.5},"minHeight":500,"minHeightUnit":"px","contentPosition":"bottom center"} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"align":"center","id":503,"width":64,"height":64,"sizeSlug":"full","linkDestination":"custom"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><a href="#"><img src="<?php echo esc_url( get_template_directory_uri() );?>/assets/images/right.png" alt="" class="wp-image-503" width="64" height="64"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div></div>
<!-- /wp:cover --></div>
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() );?>/assets/images/gallary2.jpg","id":500,"dimRatio":30,"overlayColor":"black","focalPoint":{"x":0.39,"y":0.51},"minHeight":500,"minHeightUnit":"px","contentPosition":"bottom center"} -->
