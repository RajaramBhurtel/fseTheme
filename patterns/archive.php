...
<main class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0"><!-- wp:query-title {"type":"archive","textAlign":"center","level":2,"align":"full","style":{"typography":{"fontStyle":"normal","fontWeight":"900"}},"textColor":"foreground","fontSize":"huge"} /-->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar-posts","theme":"evit-fse","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></main>
<!-- /wp:group -->